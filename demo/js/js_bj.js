...
window.onload = function() {
			...
			// 被点击slide的中心点
						...
						if(tag!=null){
							...
							for(var i in data){
								//console.log(data[i])
								html+="<div class='request-content'><img style='width:120px;height:145px;' src="+data[i].image+"><div class='request-content-detail'><div>"+data[i].author+"</div><div class='request-content-summary'>"+data[i].summary+"</div><div class=''>"+data[i].pubdate+"</div></div></div>"
							}
